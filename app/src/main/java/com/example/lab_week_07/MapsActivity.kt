...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
        ...
        requestPermissionLauncher =
            registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted ->
                if (isGranted) {
                    ...
                    // A rationale dialog is used for a warning to the user that the app
                    // will not work without the required permission
    ...
    // A rationale dialog is used for a warning to the user that the app will not work
    // without the required permission
    // Usually it's brought up when the user denies the needed permission in the previous request
